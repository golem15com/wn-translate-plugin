...
return [
    ...
    'messages' => [
        ...
        'scan_messages_purge_confirm' => 'Weet je zeker dat je alle berichten wilt verwijderen? Dit kan niet ongedaan worden!',
        'scan_messages_purge_deleted_label' => 'Verwijder ontbrekende berichten na het scannen',
        'scan_messages_purge_deleted_help' => 'Indien aangevinkt, worden alle berichten die de scanner niet heeft gevonden, inclusief de vertalingen, verwijderd nadat de scan is voltooid. Dit kan niet ongedaan worden!',
        'hint_translate' => 'Hier kan je berichten vertalen die op de website worden gebruikt, de velden worden automatisch opgeslagen.',
        'hide_translated' => 'Verberg vertaald',
